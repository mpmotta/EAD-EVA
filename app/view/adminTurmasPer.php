            ...
            <section class="container main bg-white">
                ...
                <hr class="pt-1 pb-1">
                     ...
                     <?php
                        ...
                        $periodo = new Periodo();
                        $consulta = $periodo->consultarPeriodos();
                        foreach ($consulta as $linha) {
                            $periodo = $linha['periodo'];
                            $periodoId = $linha['id_periodo'];
                            echo "
                            <figure class='ucs'>
                                <h3>PERÍODO</h3>
								<h2 class='py-3'>$periodo</h2>
							<figcaption>
								<a href='adminTurmasDisc.php?id=$periodoId' class='btn btn-warning uc'>ACESSAR</a>
							</figcaption>
						</figure>";
                        }
                        ?>
                    ...
                    <div class="modal-body p-5 cadastra">
                        <form action="../controller/turmaController.php?action=matricularAluno" method="post">
                            ...
                            <select name="turma" class="form-control" required>
                                <option selected disabled hidden value="">Turma</option>
                                <option value="INF-M1">INF-M1</option>
                                <option value="INF-M2">INF-M2</option>
                                <option value="INF-T1">INF-T1</option>
                                <option value="INF-T2">INF-T2</option>
                                <option value="INF-N1">INF-N1</option>
                                <option value="INF-N2">INF-N2</option>
                                <option value="ADM-M1">ADM-M1</option>
                                <option value="ADM-M2">ADM-M2</option>
                                <option value="ADM-N1">ADM-N1</option>
                                <option value="ADM-N2">ADM-N2</option>
                            </select>
